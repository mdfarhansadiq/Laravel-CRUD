					...
					<div class="wrapper">
						<div class="row no-gutters">
				            ...
				            Your message was sent, thank you!
									...
									<form method="POST" id="contactForm" enctype="multipart/form-data" name="contactForm" class="contactForm" action="{{ url('/home/create') }}">
                                        @csrf
										<div class="row">
											<div class="col-md-12">
											...
											<div class="col-md-12">
												<div class="form-group">
													<textarea name="user_message" class="form-control" id="message" cols="30" rows="6" placeholder="Message"></textarea>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
